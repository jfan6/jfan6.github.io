...
describe('HTTPSignature', function () {
    describe('#validate', function () {
        it('returns true when the signature is valid', async function () {
            ...
            const actual = await http_signature_service_1.HTTPSignature.validate(requestMethod, requestUrl, requestHeaders, requestBody);
            const expected = true;
            assert_1.default.equal(actual, expected, 'The signature should have been validated');
        });
...
//# sourceMappingURL=http-signature.service.test.js.map